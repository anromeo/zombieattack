function RVillain(game, x, y, spawnPoints) {
    ...
    this.strength = 40;
    this.setMovingAnimation(ASSET_MANAGER.getAsset("./images/Rzombie-moving.png"), this.SpriteHeight, this.SpriteWidth, .05, 25, true, false, 5);
...
RVillain.prototype = new Villain();
RVillain.prototype.constructor = RVillain;

RVillain.prototype.update = function () {
